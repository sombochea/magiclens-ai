...
const App: React.FC = () => {
  ...
  const [brushSmoothing, setBrushSmoothing] = useState(40); // 0 to 100
  ...
  const initEditorWithImage = (src: string) => {
    ...
    img.onload = () => {
      const maxDim = 2048;
      const resScale = Math.min(1, maxDim / Math.max(img.width, img.height));
      const w = Math.floor(img.width * resScale);
      const h = Math.floor(img.height * resScale);
          ...
          <div className="bg-[#0f0f11] border border-white/10 rounded-[40px] p-10 max-w-xl w-full shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-8 relative">
              ...
              <div className="space-y-4">
                <p className="text-gray-300 leading-relaxed font-medium text-sm">MagicLens AI is a high-performance creative suite designed for the next generation of visual artists. Experience seamless image generation and powerful AI-assisted editing tools with natural language.</p>
