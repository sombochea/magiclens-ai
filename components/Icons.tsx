...
export const IconBrush = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m9.06 11.9 8.07-8.06a2.85 2.85 0 1 1 4.03 4.03l-8.06 8.08"/><path d="M7.07 14.94c-1.66 0-3 1.35-3 3.02 0 1.33-2.5 1.52-2.5 2.24 0 .46.62.8 1 .8.66 0 1-.34 1-1.2.36.03.73.04 1.11.04 3.15 0 6.31-1.69 6.81-4.9Z"/></svg>
);

export const IconSpray = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M3 3h.01"/><path d="M7 5h.01"/><path d="M5 7h.01"/><path d="M3 7h.01"/><path d="M7 3h.01"/><path d="M5 3h.01"/><path d="M5 5h.01"/><path d="M19 9h.01"/><path d="M21 9h.01"/><path d="M12 22v-8"/><path d="M15 14h-6"/><path d="M19 14h-2.14l-1.6-4.2a2 2 0 0 0-3.13-.53l-.57.53a2 2 0 0 0 0 2.82l2.36 2.37"/><path d="M8.86 14H5a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h4.5"/></svg>
);

export const IconMarker = ({ className }: { className?: string }) => (
...
export const IconFlipCamera = ({ className }: { className?: string }) => (
...
export const IconRestore = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/><path d="m12 7 3 5-3 5"/></svg>
);
...
export const IconRotateCw = ({ className }: { className?: string }) => (
...
export const IconScaling = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M21 3 9 15"/><path d="M12 3H3v18h18v-9"/><path d="M16 3h5v5"/><path d="M21 15v6"/></svg>
);
